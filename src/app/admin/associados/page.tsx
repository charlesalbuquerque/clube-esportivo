  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-xl font-semibold text-zinc-900">Associados</h1>
      ...
      {!error && associados?.length === 0 && (
        <p className="text-sm text-zinc-600">Nenhum associado encontrado.</p>
      )}
          ...
          <table className="w-full text-sm">
            <thead className="border-b border-zinc-200 bg-zinc-50 text-left text-zinc-600">
              <tr>
                ...
                <th className="px-4 py-2 font-medium">Associado desde</th>
